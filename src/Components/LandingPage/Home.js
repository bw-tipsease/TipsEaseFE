...
import TipForm from './Workers/TipForm'
import WorkerBTN from './Workers/WorkerBTN';
...
//     useEffect(() => {
//       AxiosWithAuth()
//         .get("localhost:4000/restricted/data")
//         .then(res => {
//           console.log(res);
...
//     }, []);
//     const fetchData = () => {
//       axios.get(`localhost:4000/api/restricted/data`)
//       .then(res => {
